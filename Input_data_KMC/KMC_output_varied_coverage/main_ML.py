...
class ML_Fitting:    
    def __init__(self,Atomic_csv,Stoich_csv,Param_Guess_csv,Input_csv,Sim_folder_name='Sim_*',Input_Format ='KMC'): #Inputs necessary to initialize the MK Model
        ...
        if self.Input_Format == 'KMC':
            self.Input = self.KMC_Input_Folders_Initialization()
...
#-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    #-------------------------------------------------------------------------------------------------------------------------------------
    def three_d_plot_Exp_only(self,p_c = 0.1):
    ...
    def ML_Model_Select(self,ALGORITHM_NAME = "KNN"):
        ...
        reg = self.ML_model(X_train = X_train, Y_train = Y_train, algorithm = ALGORITHM_NAME)
        end_time = time.time()
    ...
    #-------------------------------------------------------------------------------------------------------------------------------------
    def ML_Fitting(self,algorithm = 'KNN', plot=True):

        reg = self.ML_Model_Select(ALGORITHM_NAME = algorithm)
