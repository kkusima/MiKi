...
file_name = '/project/grabow/klkusima/work/KMC/CO_Oxidation/ML_Testing/Test2.xyz'
...
# Extracting initial coverages
#Remember: A='CO*'; B='O*'
Exp_init_coverages = np.empty([len(Sim_folder_names),4]) #Expected intital coverages (Should match simulation folder names)
...
#Checking all simulations were completed as expected
...
ofile.write('\n*MIKI files loaded and intitalization completed*\n')
ofile.write('---------------------------------------------')
...
ofile.write('\n Log Ratio Correction and Percent Difference Made\n')
ofile.write('---------------------------------------------')
...
ofile.write('\n Feature(X) and Target(Y) Datasets created\n')
ofile.write('---------------------------------------------')
...
ofile.write('\n Train Test Split done (10%) created\n')
ofile.write('---------------------------------------------')
