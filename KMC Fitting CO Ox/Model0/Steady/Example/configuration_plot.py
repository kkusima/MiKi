...
#CO 
    ...
    plt.figure(figsize=(80, 40), dpi=160)
    plt.scatter(X1,Y1,c='grey', marker="o",s=160)
    plt.scatter(X2,Y2,c='grey', marker="^",s=160)
    plt.scatter(coord_x_fcc_O,coord_y_fcc_O,c='red', marker="o",s=160)
    plt.scatter(coord_x_hcp_O,coord_y_hcp_O,c='red', marker="^",s=160)
    plt.scatter(coord_x_fcc_CO,coord_y_fcc_CO,c='b', marker="o",s=160)
    plt.scatter(coord_x_hcp_CO,coord_y_hcp_CO,c='b', marker="^",s=160)
