...
def check_SS(trans_vec,tol=0.10,feature='coverage'): #Function for checking if steady state has been reached
        ...
        if feature=='coverage':
            ...
            if steady_diff < 40:
                ...
                msg = 'Warning: STEADY STATE MAY NOT HAVE BEEN REACHED. Difference in a set of last two coverage terms is NOT less than 40.Last terms are returned anyways.'
...
for i in dirs:
    ...
    os.chdir(cwd)
    with open('t_avg_1e-12bar.txt','a') as f:
